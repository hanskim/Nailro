...
<form action="<%=request.getContextPath()%>/join.me" name="form" method="post">
 <table class="tableClass">
  <tr class="trClass">
   <td class="tdClassTitle"> <b>네일로 이용약관 동의</b>
   </td>
  </tr>
  
  <tr class="trClass">
  
   <td class="tdClassTitle">
   <hr><br>
   <p align="left">
   <span style="padding-left: 160px"><b>네일로 약관내용  </b></span>
   </p>
   <br>
